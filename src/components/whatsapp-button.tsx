...
export function WhatsAppButton() {
  const phoneNumber = "+919876543210"; // Placeholder Indian Number
  ...
  return (
    <a
      ...
      className="whatsapp-float bg-[#25D366] p-4 rounded-full shadow-lg flex items-center justify-center text-white"
